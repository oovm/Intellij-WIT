...
public class WitVariantBodyNode extends WitElement implements WitVariantBody {

  public WitVariantBodyNode(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull WitVisitor visitor) {
    visitor.visitVariantBody(this);
  }
